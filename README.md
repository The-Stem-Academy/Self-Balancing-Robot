...
<img src="https://github.com/The-Stem-Academy/Self-Balancing-Robot/blob/main/Mounting_The_Motors.png?raw=true" width="50%" style="transform: rotate(90deg);" alt="Mounting the Motors">
